 ...
 *      to do an interaction with user.
 *
...
public class EngineUI
{
    ...
    private static void showLoginPage()
    {
        ...
        else        // there isn't this username in the system
        {
            ...
            if(registerStatus.equalsIgnoreCase("Y"))        // if user want to register
            {
     ...
     *          including profile and purchased histories(if there is).
     */
    private static void showProfilePage()
    {
        ...
        do 
        {
            ...
            else                             // display purchased books history
            {
     ...
     *
     * @param books list of books that system want to display
     */
